...
if(count($input_error)==0){
  ...
  if(mysqli_num_rows($name_chack)==0){
     ...
     $email_chack=mysqli_query($link,"SELECT * FROM `job` WHERE email='$email'");
...
<article class="card-body mx-auto" style="max-width: 400px;">
  <h4 class="card-title mt-3 text-center"> Allegation form  </h4>
  ...
  <div class="form-group input-group">
    <div class="input-group-prepend">
        ...
        <input class="form-control" placeholder="Enter allegation" name="name"value="<?php if(isset($name)){echo $name;}?>"type="text">
        <label class="error">
        <?php
    ...
    <div class="form-group">
        <button type="submit" name="reg"class="btn btn-primary btn-block"> Submit  </button>
    </div>      
