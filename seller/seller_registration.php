...
if(count($input_error)==0){
  $name_chack=mysqli_query($link,"select * from seller_registration where name='$name';");
  if(mysqli_num_rows($name_chack)==0){

     $email_chack=mysqli_query($link,"select * from seller_registration where email='$email';");
    ...
    $c_password=md5($c_password);
     ...
     $query="INSERT INTO `seller_registration` (`id`, `name`, `email`, `password`, `c_password`, `place`, `status`) VALUES (NULL, '$name', '$email', '$password', '$c_password', 'narayangonj', 'inactive');";
...
<?php
 ...
 if(isset($_POST['login'])){
  ...
  $sq=mysqli_query($link,"SELECT * FROM `seller_registration` WHERE `email`='$email' AND password='$password'");
...
<article class="card-body mx-auto" style="max-width: 400px;">
  ...
  <div class="form-group input-group">
    <div class="input-group-prepend">
        ...
        <input class="form-control" placeholder="Shop name" name="name"value="<?php if(isset($name)){echo $name;}?>"type="text">
        <label class="error">
        <?php
    ...
    <div class="form-group input-group">
      <div class="input-group-prepend">
        ...
        <input class="form-control" placeholder="Create password" name="password"value="<?php if(isset($password)){echo $password;}?>" type="password">
        <label class="error">
        <?php
    ...
    <div class="form-group input-group">
      <div class="input-group-prepend">
        ...
        <input class="form-control" placeholder="Repeat password" name="c_password"value="<?php if(isset($c_password)){echo $c_password;}?>"type="password">
         <label class="error">
        <?php
